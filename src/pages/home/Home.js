        ...
        <Grid container spacing={1} alignItems="center">
          <Grid item md={6} xs={6} sm={6} onClick={()=>history.push(
            ...
            >
              ...
              <h3 style={{ color: "#ED1B24", marginBottom: 1, marginTop: 0 }}>
          ...
          <Grid item md={6} xs={6} sm={6} onClick={()=>history.push(
            ...
            >
              ...
              <h3 style={{ color: "#49A748", marginBottom: 1, marginTop: 0 }}>
                Simulação de gastos
              </h3>
            </Box>
          </Grid>
          <Grid item md={6} xs={6} sm={6} onClick={()=>history.push(
            ...
            >
              ...
              <h3 style={{ color: "#00ade0", marginBottom: 1, marginTop: 0 }}>
          ...
          <Grid item md={6} xs={6} sm={6}>
            ...
            >
              ...
              <h3 style={{ color: "#f79735", marginBottom: 1, marginTop: 0 }}>
                Meus pedidos
              </h3>
            </Box>
          </Grid>
          ...
          >
            <Box
              className={classes.card_options_2}
              alignItems="center"
              border={1}
              style={{ borderColor: "#00ade0" }}
            >
              <Grid container spacing={1} justify="center" alignItems="center">
                <Grid item md={10} xs={10} sm={10}>
                  <h3 style={{ color: "#00ade0", margin: 0, padding: 0 }}>
                    MAIS SERVIÇOS
                  </h3>
                </Grid>
                <Grid item md={1} xs={1} sm={1}>
