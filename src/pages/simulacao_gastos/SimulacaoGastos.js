...
import {Table, TableHead, TableCell, TableBody, TableRow, Grid} from "@material-ui/core";
      ...
      <Container component="main" maxWidth="xs">
        ...
        <Table size="small">
          ...
          <Grid item sm={12} xs={6}>
            <Button variant="contained" fullWidth color="primary">Adicionar</Button>
          </Grid>
          <Grid item sm={12} xs={6}>
            <Button variant="contained" fullWidth color="primary">Simular</Button>
          </Grid>
        </Grid>
        </div>
        <CustomFab />
